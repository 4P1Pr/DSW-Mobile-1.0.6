 ...
 */
class AspirationListPresenter(
        private val userRepository: UserRepository,
        private val complaintQuestionRepository: ComplaintQuestionQuestionRepository,
        private val schedulerProvider: SchedulerProvider,
        private val netManager: NetManager): GenericPresenter<AspirationListContract.View>(),
        AspirationListContract.Presenter {

    override var view: AspirationListContract.View? = null
