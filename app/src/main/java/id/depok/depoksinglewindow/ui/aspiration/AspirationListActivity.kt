...
class AspirationListActivity: BaseActivity<AspirationListContract.Presenter>(),
        AspirationListContract.View {

    override val presenter by inject<AspirationListContract.Presenter>()
    ...
    override fun showCreatePage(isComplaint: Boolean) {
        val intent = Intent(this, AspirationPageActivity::class.java)
    ...
    private fun initialize() {
        ...
        binding.apply {
            ...
            recyclerviewComplaintlistComplaintrecycler.layoutManager = LinearLayoutManager(
                    this@AspirationListActivity, LinearLayoutManager.VERTICAL, false)
        }
