 ...
 */
class AspirationPagePresenter(private val userRepository: UserRepository,
        ...
        GenericPresenter<AspirationPageContract.View>(),
        AspirationPageContract.Presenter, KoinComponent {

    override var view: AspirationPageContract.View? = null
